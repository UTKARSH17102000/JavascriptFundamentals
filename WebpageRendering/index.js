...
// Good senior-level interview questions around this topic
// Some strong interview-style questions (all of these are now included as comments in AsyncAndDefer/index.js):

// Rendering & CRP

// Q1: Walk me through the critical rendering path from URL entry until the page is interactive.
// Q2: Difference between DOM, CSSOM, render tree, layout, paint, compositing? Which stages are most expensive and why?
// Q3: How do CSS and JavaScript each block or delay first paint and DOMContentLoaded?
// Q4: How do async and defer change script loading/execution timing and their impact on DOMContentLoaded and load?
// Q5: Techniques to optimize LCP and FCP on content-heavy pages?
// Browser internals / performance

// Q6: What is layout thrashing? How would you detect and fix it?
// Q7: Which CSS properties trigger layout vs paint vs compositing, and why does it matter?
// Q8: How do you minimize main-thread blocking work on initial load?
// Q9: What are Core Web Vitals, and which parts of the pipeline affect each?
// Q10: How would you debug a slow rendering issue using Chrome DevTools?
// Resource loading & networking

// Q11: How do HTTP/2/HTTP/3 change your bundling/loading strategy?
// Q12: When to use preload, prefetch, and preconnect, and how they impact rendering?
// Q13: How do CDNs and caching headers (Cache-Control, ETag) impact user-perceived performance?
// Architecture & frameworks

// Q14: Compare CSR, SSR, and hydration in terms of TTFB, first paint, and TTI.
// Q15: How would you architect a perf-sensitive landing page vs a complex SPA?
// Q16: Rendering pitfalls you’ve hit with React/Vue/Angular, and how you fixed them.
// Advanced / edge cases

// Q17: Difference in reflow/repaint cost when changing a class on a top-level container vs a deep child?
// Q18: Rendering impact of web fonts (FOIT/FOUT), and how to mitigate.
// Q19: How to diagnose and fix scroll/animation jank on large lists?
// Q20: How do IntersectionObserver and requestIdleCallback help schedule work more friendly to the rendering pipeline?